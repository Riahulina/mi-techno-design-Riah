<x-layout>
    <div class="max-w-3xl mx-auto py-20">
        <h2 class="text-3xl font-bold text-blue-800 mb-6 text-center">Tambah Anggota Baru</h2>

        <form action="{{ route('anggota.store') }}" method="POST" class="bg-white p-6 rounded-2xl shadow-md">
            @csrf
