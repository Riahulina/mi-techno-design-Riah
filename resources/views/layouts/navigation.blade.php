<nav x-data="{ open: false }" class="bg-gray-300 border-b border-gray-100 shadow-md">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('Home') }}">
                        <img src="{{ asset('images/logokabinet.png') }}" alt="Logo" class="size-15 mt-2">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-lg">
                    <x-nav-link :href="route('Home')" :active="request()->routeIs('Home')" class="text-xl text-black px-3 py-0.5 rounded-lg hover:bg-gray-500 hover:text-white transition duration-200"
                        >
                        {{ __('Home') }}
                    </x-nav-link>                    
                </div>
...
<div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-blue-600 text-white">
    <div class="pt-2 pb-3 space-y-1">
        <x-responsive-nav-link :href="route('profile.edit')" :active="request()->routeIs('profile.edit')" class="text-white hover:bg-blue-700">
            {{ __('Profile') }}
